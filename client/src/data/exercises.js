...
const EXERCISES = [
  ...
  { id: 57, name: 'Squat machine', nameEn: 'Leg Press', muscleGroup: 'jambes', difficulty: 'beginner' },
  { id: 58, name: 'Fentes avant', nameEn: 'Lunges', muscleGroup: 'jambes', difficulty: 'intermediate' },
  { id: 59, name: 'Fentes walking', nameEn: 'Walking Lunges', muscleGroup: 'jambes', difficulty: 'intermediate' },
  { id: 60, name: 'Fentes inversées', nameEn: 'Reverse Lunges', muscleGroup: 'jambes', difficulty: 'intermediate' },
  { id: 61, name: 'Leg curl', nameEn: 'Leg Curl', muscleGroup: 'jambes', difficulty: 'beginner' },
  { id: 62, name: 'Leg extension', nameEn: 'Leg Extension', muscleGroup: 'jambes', difficulty: 'beginner' },
  { id: 63, name: 'Presse jambes machine', nameEn: 'Machine Leg Press', muscleGroup: 'jambes', difficulty: 'beginner' },
  { id: 64, name: 'Leg press 45°', nameEn: '45 Degree Leg Press', muscleGroup: 'jambes', difficulty: 'intermediate' },
  { id: 65, name: 'Hip thrust', nameEn: 'Hip Thrust', muscleGroup: 'jambes', difficulty: 'beginner' },
  { id: 66, name: 'Hip thrust machine', nameEn: 'Hip Thrust Machine', muscleGroup: 'jambes', difficulty: 'beginner' },
  { id: 67, name: 'Bulgarian split squat', nameEn: 'Bulgarian Split Squat', muscleGroup: 'jambes', difficulty: 'intermediate' },
  { id: 68, name: 'Step ups', nameEn: 'Step Ups', muscleGroup: 'jambes', difficulty: 'intermediate' },
  { id: 69, name: 'Sissy squat', nameEn: 'Sissy Squat', muscleGroup: 'jambes', difficulty: 'advanced' },

  // ===== FESSES (Glutes) =====
  { id: 70, name: 'Hip thrust barre', nameEn: 'Barbell Hip Thrust', muscleGroup: 'fesses', difficulty: 'intermediate' },
  { id: 71, name: 'Soulevé de terre jambes tendues', nameEn: 'Stiff Leg Deadlift', muscleGroup: 'fesses', difficulty: 'intermediate' },
  { id: 72, name: 'Abduction machine', nameEn: 'Abduction Machine', muscleGroup: 'fesses', difficulty: 'beginner' },
  { id: 73, name: 'Kickback machine', nameEn: 'Glute Kickback', muscleGroup: 'fesses', difficulty: 'beginner' },

  // ===== ABS/CORE (Abs) =====
  { id: 74, name: 'Crunches', nameEn: 'Crunches', muscleGroup: 'abs', difficulty: 'beginner' },
  { id: 75, name: 'Sit-ups', nameEn: 'Sit-ups', muscleGroup: 'abs', difficulty: 'beginner' },
  { id: 76, name: 'Relevé de jambes', nameEn: 'Leg Raises', muscleGroup: 'abs', difficulty: 'intermediate' },
  { id: 77, name: 'Machine abs', nameEn: 'Ab Machine', muscleGroup: 'abs', difficulty: 'beginner' },
  { id: 78, name: 'Abdominale câble', nameEn: 'Cable Crunch', muscleGroup: 'abs', difficulty: 'beginner' },
  { id: 79, name: 'Planche', nameEn: 'Plank', muscleGroup: 'abs', difficulty: 'intermediate' },
